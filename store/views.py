...
class ProductViewApi(generics.ListCreateAPIView):
...
def product_pdf(request):
	...
	for product in products:
		...
		lines.append(f'Product Description:{product.description}'),
		lines.append("\n#%"*10),
	...
	response = FileResponse(buf,as_attachment=True,filename='product.pdf')
	return response
